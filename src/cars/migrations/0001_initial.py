    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cars.subdivision')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_class', models.ForeignKey(blank=True, db_column='class', null=True, on_delete=django.db.models.deletion.SET_NULL, to='cars.carclass', verbose_name='Класс автомобиля')),
                ...
                ('service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cars.maintenanceservice', verbose_name='Служба эксплутации')),
                ...
                ('subdivision', models.ForeignKey(blank=True, db_column='owner', null=True, on_delete=django.db.models.deletion.SET_NULL, to='cars.subdivision', verbose_name='Подразделение-владелец транспорта')),
